...
assert(index.includes("<title>基层临床助手</title>"), "浏览器标题必须使用统一平台名称");
assert(index.includes('<h1 id="pageTitle">基层临床助手</h1>'), "首页初始大标题必须为基层临床助手");
...
assert(brandScript.includes("基层用药助手"), "品牌兼容脚本必须继续兼容原用药模块标题");
